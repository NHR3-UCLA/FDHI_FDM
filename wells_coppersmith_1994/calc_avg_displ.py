...
from wells_coppersmith_1994.functions import _calc_params_ad


def func_ad(*, magnitude, percentile, style="all"):
    """
    ...
    mu, sigma = _calc_params_ad(magnitude=magnitude, style=style)
